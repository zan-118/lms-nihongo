...
export function GrammarCard({ article, index, selectedLevel }: GrammarCardProps) {
  ...
  const levelColors: Record<string, string> = {
    n5: "text-emerald-500 border-emerald-500/20 bg-emerald-500/5 shadow-[0_0_10px_rgba(16,185,129,0.1)]",
    n4: "text-cyan-500 border-cyan-500/20 bg-cyan-500/5 shadow-[0_0_10px_rgba(6,182,212,0.1)]",
        ...
        <Card className="h-full p-6 bg-card/40 backdrop-blur-xl border border-white/5 rounded-[2rem] group transition-all duration-500 flex flex-col cursor-pointer hover:border-primary/50 hover:bg-card/60 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="w-10 h-10 rounded-2xl bg-white/[0.03] border border-white/5 flex items-center justify-center group-hover:border-primary/30 group-hover:bg-primary/10 transition-all duration-500">
                <Bookmark
                  size={18}
            ...
            <div className="mt-8 pt-5 border-t border-white/5 flex items-center justify-between">
              ...
              <div className="w-9 h-9 rounded-xl bg-white/[0.03] border border-white/5 flex items-center justify-center group-hover:bg-primary group-hover:text-white dark:group-hover:text-black group-hover:border-transparent transition-all duration-500 group-hover:shadow-[0_0_15px_rgba(0,238,255,0.3)]">
                 <ArrowRight size={16} />
              </div>
            </div>
          </div>
