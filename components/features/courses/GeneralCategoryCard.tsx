          ...
          <div className="grid gap-3 mb-10 relative z-10">
            ...
            {cat.previews.map((preview) => (
              <Link
                ...
                className="group/item flex items-center justify-between p-4 rounded-2xl bg-muted/30 border border-border hover:bg-warning/10 hover:border-warning/30 transition-all duration-300"
              >
