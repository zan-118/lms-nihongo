        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-10 border-b border-border pb-6 md:pb-12">
          <div className="flex items-center gap-5 md:gap-6">
            ...
            <div className="text-left">
              ...
              <span className="text-xs md:text-xs text-muted-foreground font-medium tracking-tight uppercase tracking-widest">Perkaya perbendaharaan kata bahasa Jepang Anda.</span>
            </div>
          </div>
